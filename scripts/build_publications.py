...
ENTRY_TYPES = {
    ...
    # Portuguese-language publications, kept as their own BibTeX type so the
    # source file stays a faithful copy of the author's own record.
    "ptjournal": ("journal", "Journal Article (Portuguese)", "Journal"),
    "ptconf": ("conference", "Conference Proceedings (Portuguese)", "Conference"),
}
GROUPS = [
